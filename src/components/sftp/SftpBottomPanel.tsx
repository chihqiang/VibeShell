...
export function SftpBottomPanel({ show, height, onResizeStart }: SftpBottomPanelProps) {
  ...
  return (
    <>
      <div
        className="shrink-0 h-[5px] bg-border cursor-row-resize hover:bg-primary/40 active:bg-primary/60 transition-all duration-150 relative"
      ...
      <div className="shrink-0 flex flex-col bg-background animate-slide-in" style={{ height }}>
